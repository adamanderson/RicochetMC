...
//
//
// $Id: RMCCRYGeneratorMessenger.cc,v 1.8 2002/12/16 16:37:27 maire Exp $
...
RMCCRYGeneratorMessenger::RMCCRYGeneratorMessenger(
                                          RMCCRYGenerator* Gun)
  :Action(Gun)
{
...
void RMCCRYGeneratorMessenger::SetNewValue(
