...
public:
  ...
  void SetProcID(std::string pProcID) {procID = pProcID;}
  void SetParentProcID(std::string parprocID) {parentprocID = parprocID;}
  ...
  std::string GetProcID() const {return procID;}
  std::string GetParentProcID() const {return parentprocID;}
