...
#include "RMCactions/RMCTrackAction.hh"
#include "RMCactions/RMCStepAction.hh"
...
int main(int argc,char** argv)
{
    ...
    CLHEP::HepRandom::setTheSeed((unsigned)time(NULL)+(int)r->Uniform(0,100000000));
    ...
    RMCTrackAction* track_action = new RMCTrackAction();
    runManager->SetUserAction(track_action);

    RMCStepAction* step_action = new RMCStepAction();
